                        ...
                        @include('includes.admin.form-both')
												...
												<div class="row">
													...
													<div class="col-lg-7">
                                                        ...
                                                        <input type="text" class="input-field" placeholder="{{ __('Enter Product Name In Persian') }}" name="name_fa" required="" value="{{ $data->name_fa }}">
				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
												...
												<div class="row">
													...
													<div class="col-lg-7">
                                                        ...
                                                        <input type="text" class="input-field" placeholder="{{ __('Estimated Shipping Time In Persian') }}" name="ship_fa" value="{{ $data->ship_fa == null ? "" : $data->ship_fa }}">
											...
											<div class="{{ $data->measure == null ? 'showbox' : '' }}">
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-lg-7">
                                                      <div class="text-editor">
                                                          <textarea name="details_fa" class="nic-edit-p">{{$data->details_fa}}</textarea>
                                                      </div>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-lg-7">
                                                      <div class="text-editor">
                                                          <textarea name="policy_fa" class="nic-edit-p">{{$data->policy_fa}}</textarea>
                                                      </div>
                                                  </div>
                                              </div>
