                        ...
                        @include('includes.admin.form-both')
												...
												<div class="row">
													...
													<div class="col-lg-7">
                                                        ...
                                                        <input type="text" class="input-field" placeholder="{{ __('Enter Product Name In Persian') }}" name="name_fa" required="">
                                                    </div>
												</div>
													...
													<div class="col-lg-7">
															<select id="cat" name="category_id" required="">
																	<option value="">{{ __('Select Category') }}</option>
						                                              @foreach($cats as $cat)
						                                                  <option data-href="{{ route('admin-subcat-load',$cat->id) }}" value="{{ $cat->id }}">{{$cat->name_fa}} -- {{$cat->name}}</option>
						                                              @endforeach
						                                     </select>
													</div>
												</div>
				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
												...
												<div class="row">
													...
													<div class="col-lg-7">
                                                        ...
                                                        <input type="text" class="input-field" placeholder="{{ __('Estimated Shipping Time In Persian') }}" name="ship_fa">
                                                    </div>
												</div>
											...
											<div class="showbox">
                                              ...
                                              <div class="row">
                                                  <div class="col-lg-4">
                                                      <div class="left-area">
                                                          ...
                                                          <p class="sub-heading">{{ __('(In Persian)') }}</p>

                                                      </div>
                                                  </div>
                                                  <div class="col-lg-7">
                                                      <div class="text-editor">
                                                          <textarea class="nic-edit-p" name="details_fa"></textarea>
                                                      </div>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-lg-7">
                                                      <div class="text-editor">
                                                          <textarea class="nic-edit-p" name="policy_fa"></textarea>
                                                      </div>
                                                  </div>
                                              </div>
