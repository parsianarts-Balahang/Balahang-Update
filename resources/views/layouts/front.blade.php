						...
						<div class="search-box">
							<div class="categori-container" id="catSelectForm">
								<select name="category" id="category_select" class="categoris">
									...
									<option value="{{ $data->slug }}" {{ Request::route('category') == $data->slug ? 'selected' : '' }}>{{ $lang ?  $data->name_fa : $data->name }}</option>
									@endforeach
								</select>
							</div>
					...
					<nav hidden>
						...
						<ul class="menu">
							...
							@foreach(DB::table('pages')->where('header','=',1)->get() as $data)
								<li><a href="{{ route('front.page',$data->slug) }}">{{ $lang ? $data->title_fa : $data->title }}</a></li>
							@endforeach
							@if($gs->is_contact == 1)
						...
						<ul class="link-list">
							...
							<li>
								<a href="{{ route('front.page',$data->slug) }}">
									<i class="fas fa-angle-double-right"></i>{{ $lang ? $data->title_fa : $data->title }}
								</a>
							</li>
							@endforeach
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
							<div class="content">
								<div class="content">
									<p>{!! $lang ? $gs->copyright_fa : $gs->copyright !!}</p>
							</div>
						</div>
					</div>
				</div>
