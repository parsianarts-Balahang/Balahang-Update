                      ...
                      <form id="geniusform" action="{{route('admin-faq-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            ...
                            <input type="text" class="input-field" name="title_fa" placeholder="{{ __('persian Title') }}" required="" value="{{ Request::old('title_fa') }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              ...
                              <textarea  class="nic-edit" name="details_fa" placeholder="{{ __('Description') }}">{{ Request::old('details_fa') }}</textarea> 
                          </div>
                        </div>
