      ...
      <div class="row">
         <div class="col-lg-12">
            <ul class="pages">
               ...
               @if (!empty($cat))
               <li>
                  <a href="{{route('front.category', $cat->slug)}}">{{ $lang ? $cat->name_fa : $cat->name }}</a>
               </li>
               @endif
               @if (!empty($subcat))
               <li>
                  <a href="{{route('front.category', [$cat->slug, $subcat->slug])}}">{{ $lang ? $subcat->name_fa : $subcat->name }}</a>
               </li>
               @endif
               @if (!empty($childcat))
               <li>
                  <a href="{{route('front.category', [$cat->slug, $subcat->slug, $childcat->slug])}}">{{ $lang ? $childcat->name_fa : $childcat->name }}</a>
               </li>
               @endif
