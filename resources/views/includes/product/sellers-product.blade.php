                                ...
                                @if($prod->user->is_vendor == 2)
															...
															<div class="single-box">
																...
																<div class="right-area">
																	...
																	<p class="text"><a href="{{ route('front.product',$prod->slug) }}">{{ $lang ? (strlen($prod->name_fa) > 65 ? substr($prod->name_fa,0,65).'...' : $prod->name_fa) : (strlen($prod->name) > 65 ? substr($prod->name,0,65).'...' : $prod->name) }}</a></p>
