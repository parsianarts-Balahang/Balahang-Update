                    ...
                    <tr class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}">
                      <td class="product-img">
                        <div class="item">
                          ...
                          <p class="name"><a href="{{ route('front.product', $product['item']['slug']) }}">{{$lang ? (mb_strlen($product['item']['name_fa'],'utf-8') > 45 ? mb_substr($product['item']['name_fa'],0,45,'utf-8').'...' : $product['item']['name_fa']) : (mb_strlen($product['item']['name'],'utf-8') > 45 ? mb_substr($product['item']['name'],0,45,'utf-8').'...' : $product['item']['name'])}}</a></p>
                        </div>
                      </td>
                                            <td>
