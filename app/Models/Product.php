...
class Product extends Model
{
    ...
    protected $fillable = ['user_id','category_id','product_type','affiliate_link','sku', 'subcategory_id', 'childcategory_id', 'attributes', 'name', 'name_fa', 'photo', 'size','size_qty','size_price', 'color', 'details', 'details_fa','price','previous_price','stock','policy', 'policy_fa', 'status', 'views','tags','featured','best','top','hot','latest','big','trending','sale','features', 'features_fa', 'colors','product_condition','ship', 'ship_fa', 'meta_tag','meta_description','youtube','type','file','license','license_qty','link','platform','region','licence_type','measure','discount_date','is_discount','whole_sell_qty','whole_sell_discount','catalog_id','slug'];
    ...
    public function showNameFA() {
        $name = mb_strlen($this->name_fa,'utf-8') > 55 ? mb_substr($this->name_fa,0,55,'utf-8').'...' : $this->name_fa;
        return $name;
    }
