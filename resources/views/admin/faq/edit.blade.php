                      ...
                      <form id="geniusform" action="{{route('admin-faq-update',$data->id)}}" method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            ...
                            <input type="text" class="input-field" name="title_fa" placeholder="{{ __('persian Title') }}" required="" value="{{$data->title_fa}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              ...
                              <textarea class="nic-edit" name="details_fa" placeholder="{{ __('Description') }}">{{ $data->details_fa }}</textarea> 
                          </div>
                        </div>
