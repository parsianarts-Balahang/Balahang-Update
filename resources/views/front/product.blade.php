    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="pages">
          ...
          <li><a href="{{route('front.category',$productt->category->slug)}}">{{$lang ? $productt->category->name_fa : $productt->category->name}}</a></li>
          @if($productt->subcategory_id != null)
            <li><a href="{{ route('front.subcat',['slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug]) }}">{{$lang ? $productt->subcategory->name_fa : $productt->subcategory->name}}</a>
            </li>
          @endif
          @if($productt->childcategory_id != null)
            <li><a href="{{ route('front.childcat',['slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug, 'slug3' => $productt->childcategory->slug]) }}">{{$lang ? $productt->childcategory->name_fa : $productt->childcategory->name}}</a>
            </li>
          @endif
          <li><a href="{{ route('front.product', $productt->slug) }}">{{$lang ? $productt->name_fa : $productt->name}}</a>
            ...
            <div class="col-lg-7">
              <div class="right-area">
                <div class="product-info">
                  <h4 class="product-name">{{$lang ? $productt->name_fa : $productt->name}}</h4>
...
{{--                  </div>--}}
                  ...
                  @if($productt->ship != null)
                    <p class="estimate-time">{{ $langg->lang86 }}: <b> {{ $lang ? $productt->ship_fa : $productt->ship}}</b></p>
                  @endif
                  ...
                  <div id="product-details-tab">
                    ...
                    <div class="tab-content-wrapper">
                      <div id="tabs-1" class="tab-content-area">
                        <p>{!! $lang ? $productt->details_fa : $productt->details !!}</p>
                      </div>
                      <div id="tabs-2" class="tab-content-area">
                        <p>{!! $lang ? $productt->policy_fa : $productt->policy !!}</p>
                      </div>
