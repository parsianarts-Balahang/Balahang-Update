...
class CartController extends Controller
{
   ...
   public function addtocart($id)
    {
        $prod = Product::where('id','=',$id)->first(['id','user_id','slug','name', 'name_fa','photo','size','size_qty','size_price','color','price','stock','type','file','link','license','license_qty','measure','whole_sell_qty','whole_sell_discount','attributes']);
   ...
   public function addcart($id)
    ...
    {
        $actual_path = str_replace('','',base_path());
